...
/**
 * Main Memman class for the project. Reads from file and executes commands
 *
...
public class Memman {
    ...
    public static void main(String[] args) {
        ...
        songs = new HashTable(hashSize, "Songs");

        MemoryManager mm = new MemoryManager(blockSize);

        FileReader reader = new FileReader(file);

        executeCommands(reader.getCommands(), mm, artists, songs);
    }
     ...
     * @param songs
     */
    public static void executeCommands(ArrayList<String> commands, MemoryManager mm, HashTable artists, HashTable songs) {
            ...
            switch(key) {
                case "insert":
                    ...
                    if (artists.duplicate(sPair.getFirst())) {
	                    MemHandle h1 = mm.insert(bPair.getFirst());
                    ...
                    if (songs.duplicate(sPair.getSecond())) {
                    	MemHandle h2 = mm.insert(bPair.getSecond());
                ...
                case "print":
                    switch(value) {
                        ...
                        case "song":
                            ...
                            for (int j = 0; j < pair2.getFirst().length; j++) {
