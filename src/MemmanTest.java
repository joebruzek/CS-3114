...
public class MemmanTest extends TestCase {
    ...
    public void testGetBytes() {
    	...
    	byte[] bytes = Memman.getBytes(test);
    ...
    public void testToPair() {
    	...
    	Pair<String, String> p = Memman.toPair(str);
    ...
    public void testToByteArray() {
    	...
    	Pair<byte[], byte[]> pair = Memman.toByteArray(p);
    	
    	assertEquals(10, Memman.getLength(pair.getFirst()));
    	assertEquals(15, Memman.getLength(pair.getSecond()));
    }
    ...
    public void testExecuteCommands() {
    	...
    	Memman.executeCommands(commands, mm, a, b);
